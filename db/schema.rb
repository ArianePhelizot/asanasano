...
ActiveRecord::Schema.define(version: 20_170_715_142_305) do
  ...
  create_table 'attachinary_files', force: :cascade do |t|
    ...
    t.index %w(attachinariable_type attachinariable_id scope), name: 'by_scoped_parent', using: :btree
  end
  ...
  create_table 'coaches_groups', id: false, force: :cascade do |t|
    ...
    t.index %w(coach_id group_id), name: 'index_coaches_groups_on_coach_id_and_group_id', using: :btree
  end

  create_table 'coaches_sports', id: false, force: :cascade do |t|
    t.integer 'coach_id', null: false
    t.integer 'sport_id', null: false
    t.index %w(coach_id sport_id), name: 'index_coaches_sports_on_coach_id_and_sport_id', using: :btree
  end
  ...
  create_table 'groups_users', id: false, force: :cascade do |t|
    ...
    t.integer 'group_id', null: false
    t.index %w(user_id group_id), name: 'index_groups_users_on_user_id_and_group_id', using: :btree
  end
  ...
  create_table 'slots_users', id: false, force: :cascade do |t|
    ...
    t.index %w(user_id slot_id), name: 'index_slots_users_on_user_id_and_slot_id', using: :btree
  end
